...
To collect the data run the ./sprof-0.5.sh at customer site. Different option can be seen with –h flag
...
/sprofpp-0.5.sh -p veikkaus -a none -c -f ../sprof-user/sprof_output.out
